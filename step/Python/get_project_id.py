...
def get_data(pid):
  ...
  and	[dbo].[PetalCandidate].Direction = 1\
  and	[dbo].[PetalCandidate].GratingType = 1 \
  and	[dbo].[HWSubsystemImaging].[ColorFilter] = 'Lime'\
  and	[dbo].[HWSubsystemImaging].[Polarization] = 1\
  and	[dbo].[HWSubsystemImaging].[NaOption] = 0\
